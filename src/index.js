...
var formula = (function () {
    ...
    met.engineering = (function () {
        ...
        exports.BIN2HEX = function (number, places) {
            ...
            if (
                ...
                return (
                    1099511627264 + parseInt(stringified.substring(1), 2)
                ).toString(16);
            }
        ...
        exports.BIN2OCT = function (number, places) {
            ...
            if (
                ...
                return (
                    1073741312 + parseInt(stringified.substring(1), 2)
                ).toString(8);
            }
        ...
        exports.CONVERT = function (number, from_unit, to_unit) {
            ...
            for (var i = 0; i < units.length; i++) {
                ...
                if (
                    units[i][1] === base_to_unit ||
                    alt.indexOf(base_to_unit) >= 0
                ) {
                    to = units[i];
                }
            }
            ...
            // Lookup from prefix
            if (from === null) {
                var from_binary_prefix =
                    binary_prefixes[from_unit.substring(0, 2)];
                ...
                if (from_binary_prefix) {
                    ...
                    base_from_unit = from_unit.substring(
                        from_unit_prefix[2].length
                    );
                }
            ...
            return (
                (number * from[6] * from_multiplier) / (to[6] * to_multiplier)
            );
        };
        ...
        exports.IMCOT = function (inumber) {
            ...
            return exports.IMDIV(
                exports.IMCOS(inumber),
                exports.IMSIN(inumber)
            );
        };
        ...
        exports.OCT2BIN = function (number, places) {
            ...
            // Check if number is negative
            var negative =
                number.length === 10 && number.substring(0, 1) === "7"
                    ? true
                    : false;
    ...
    met.financial = (function () {
        ...
        exports.CUMPRINC = function (rate, periods, value, start, end, type) {
            ...
            for (var i = start; i <= end; i++) {
                if (type > 0) {
                    ...
                    principal +=
                        payment -
                        exports.FV(rate, i - 1, payment, value, 0) * rate;
                }
            }
        ...
        exports.DOLLARDE = function (dollar, fraction) {
            ...
            var power = Math.pow(
                10,
                Math.ceil(Math.log(fraction) / Math.LN2) + 1
            );
        ...
        exports.IPMT = function (rate, period, periods, present, future, type) {
            ...
            type = utils.parseNumber(type);
            if (
                utils.anyIsError(rate, period, periods, present, future, type)
            ) {
                return error.value;
            }
            ...
            if (period === 1) {
                ...
                if (type === 1) {
                    interest =
                        exports.FV(rate, period - 2, payment, present, 1) -
                        payment;
                } else {
                    interest = exports.FV(
                        rate,
        ...
        exports.IRR = function (values, guess) {
            ...
            var irrResult = function (values, dates, rate) {
                ...
                for (var i = 1; i < values.length; i++) {
                    result +=
                        values[i] / Math.pow(r, (dates[i] - dates[0]) / 365);
                }
                return result;
            };
        ...
        exports.RATE = function (
            ...
            guess = utils.parseNumber(guess);
            if (
                utils.anyIsError(periods, payment, present, future, type, guess)
            ) {
                return error.value;
            }
        ...
        exports.TBILLPRICE = function (settlement, maturity, discount) {
            ...
            return (
                100 *
                (1 - (discount * DAYS360(settlement, maturity, false)) / 360)
            );
        };
        ...
        exports.TBILLYIELD = function (settlement, maturity, price) {
            ...
            return (
                ((100 - price) * 360) /
                (price * DAYS360(settlement, maturity, false))
            );
        };
        ...
        exports.XIRR = function (values, dates, guess) {
            ...
            var irrResult = function (values, dates, rate) {
                ...
                for (var i = 1; i < values.length; i++) {
                    result +=
                        values[i] / Math.pow(r, DAYS(dates[i], dates[0]) / 365);
                }
                return result;
            };
        ...
        exports.XNPV = function (rate, values, dates) {
            ...
            for (var i = 0; i < values.length; i++) {
                result +=
                    values[i] /
                    Math.pow(1 + rate, DAYS(dates[i], dates[0]) / 365);
            }
            return result;
        };
    ...
    met.math = (function () {
        ...
        exports.BASE = function (number, radix, min_length) {
            ...
            return (
                new Array(Math.max(min_length + 1 - result.length, 0)).join(
                    "0"
                ) + result
            );
        };
        ...
        exports.CEILING = function (number, significance, mode) {
            ...
            if (number >= 0) {
                ...
                if (mode === 0) {
                    return (
                        -1 *
                        Math.floor(Math.abs(number) / significance) *
                        significance
                    );
                } else {
                    return (
        ...
        exports.COMBIN = function (number, number_chosen) {
            ...
            return (
                exports.FACT(number) /
                (exports.FACT(number_chosen) *
                    exports.FACT(number - number_chosen))
            );
        };
    ...
    met.text = (function () {
        ...
        exports.REGEXEXTRACT = function (text, regular_expression) {
            ...
            return match
                ? match[match.length > 1 ? match.length - 1 : 0]
                : null;
        };
        ...
        exports.SEARCH = function (find_text, within_text, position) {
            var foundAt;
            if (
                typeof find_text !== "string" ||
                typeof within_text !== "string"
            ) {
                return error.value;
            }
            position = position === undefined ? 0 : position;
    ...
    met.stats = (function () {
        ...
        exports.AVERAGEIF = function (range, criteria, average_range) {
            ...
            average_range = utils.parseNumberArray(
                utils.flatten(average_range)
            );
            ...
            for (i = 0; i < args.length; i += 2) {
                ...
                for (var j = 0; j < range.length; j++) {
                    if (typeof range[j] !== "string") {
                        ...
                        results[j] =
                            results[j] && eval('"' + range[j] + '"' + criteria); // jshint ignore:line
                    }
                }
            }
            var result = 0;
        ...
        exports.MODE.MULT = function () {
            ...
            for (var i = 0; i < n; i++) {
                currentItem = range[i];
                count[currentItem] = count[currentItem]
                    ? count[currentItem] + 1
                    : 1;
...
(function (global, factory) {
    ...
    var jexcel = function (el, options) {
        ...
        obj.prepareTable = function () {
            ...
            if (
                obj.options.data &&
                typeof obj.options.data[0] !== "undefined"
            ) {
                // Data keys
        ...
        obj.createTable = function () {
            ...
            var searchText = document.createTextNode(
            ...
            for (var j = 0; j < y; j++) {
                ...
                for (var i = 0; i < x; i++) {
                    if (
                        ...
                        row[obj.options.columns[i].name] =
                            obj.options.data[j][i];
                    }
                }
        ...
        obj.prepareJson = function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                var x = data[i].x;
                var y = data[i].y;
                var k = obj.options.columns[x].name
                    ? obj.options.columns[x].name
                    : x;
        ...
        obj.createCell = function (i, j, value) {
            ...
            if (obj.options.columns[i].editor) {
                ...
                if (
                    typeof obj.options.columns[i].editor.createCell ==
                    "function"
                ) {
                ...
                if (obj.options.columns[i].type == "hidden") {
                    ...
                    if (obj.options.columns[i].type == "html") {
                        td.innerHTML = stripScript(
                            obj.parseValue(i, j, value, td)
                        );
                    } else {
                        if (
                            obj.options.stripHTML === false ||
        ...
        obj.createCellHeader = function (colNumber) {
            ...
            if (obj.options.stripHTML) {
                obj.headers[colNumber].innerText = obj.options.columns[
                    colNumber
                ].title
                    ? obj.options.columns[colNumber].title
                    : jexcel.getColumnName(colNumber);
            } else {
                obj.headers[colNumber].innerHTML = obj.options.columns[
                    colNumber
                ].title
                    ? obj.options.columns[colNumber].title
                    : jexcel.getColumnName(colNumber);
        ...
        obj.updateNestedHeader = function (x, y, title) {
            if (obj.options.nestedHeaders[y][x].title) {
                ...
                obj.options.nestedHeaders[y].element.children[
                    x + 1
                ].innerText = title;
            }
        };
            ...
            for (var i = 0; i < toolbar.length; i++) {
                if (toolbar[i].type == "i") {
                    ...
                    for (var j = 0; j < toolbar[i].v.length; j++) {
                        var toolbarDropdownOption = document.createElement(
                            "option"
                        );
        ...
        obj.setMerge = function (
            ...
            if (!cellName) {
                if (!obj.highlighted.length) {
                    ...
                    var y1 = parseInt(
                        obj.highlighted[0].getAttribute("data-y")
                    );
                    var x2 = parseInt(
                        obj.highlighted[
                ...
                for (var y = cell[1]; y < cell[1] + rowspan; y++) {
                    for (var x = cell[0]; x < cell[0] + colspan; x++) {
                        if (!(cell[0] == x && cell[1] == y)) {
                            ...
                            obj.options.mergeCells[cellName][2].push(
                                obj.records[y][x]
                            );
            ...
            if (obj.options.mergeCells[cellName]) {
                ...
                for (var j = 0; j < info[1]; j++) {
                    for (var i = 0; i < info[0]; i++) {
                        if (j > 0 || i > 0) {
                            obj.records[cell[1] + j][cell[0] + i] =
                                info[2][index];
                            obj.records[cell[1] + j][
                                cell[0] + i
                            ].style.display = "";
                            // Recover data
                            if (data && data[index]) {
        ...
        obj.openFilter = function (columnId) {
            if (!obj.options.filters) {
                ...
                var opt = {
                    ...
                    opened: true,
                    value:
                        obj.filters[columnId] !== undefined
                            ? obj.filters[columnId]
                            : null,
                    width: "100%",
                    position:
        ...
        obj.openEditor = function (cell, empty, e) {
            ...
            if (cell.classList.contains("readonly") == true) {
                ...
                if (obj.options.columns[x].editor) {
                    // Custom editors
                    obj.options.columns[x].editor.openEditor(
                        cell,
                        el,
                        empty,
                        e
                    ...
                    if (obj.options.columns[x].type == "hidden") {
                        ...
                        var value = obj.options.data[y][x];
                        if (
                            obj.options.columns[x].multiple &&
                            !Array.isArray(value)
                        ) {
                            value = value.split(";");
                        }
                        ...
                        // Create dropdown
                        if (
                            typeof obj.options.columns[x].filter == "function"
                        ) {
                        ...
                        obj.options.columns[x].options.value =
                            obj.options.data[y][x];
                        obj.options.columns[x].options.opened = true;
                        obj.options.columns[x].options.onclose = function (
                            el,
                            value
                        ) {
                            obj.closeEditor(cell, true);
                        ...
                        if (
                            window.innerHeight <
                            rect.bottom + rectContent.height
                        ) {
                            div.style.top =
        ...
        obj.closeEditor = function (cell, save) {
            ...
            if (save == true) {
                ...
                if (obj.options.columns[x].editor) {
                    // Custom editor
                    var value = obj.options.columns[x].editor.closeEditor(
                        cell,
                        save
                    );
                } else {
                    ...
                    if (
                        ...
                        if (("" + value).substr(0, 1) != "=") {
                            if (value == "") {
                                value = obj.options.columns[x].allowEmpty
                                    ? ""
                                    : 0;
                            }
                        }
        ...
        obj.getValue = function (cell, processedValue) {
            ...
            if (x != null && y != null) {
                if (
                    ...
                    if (
                        obj.options.data[y] &&
                        obj.options.data[y][x] != "undefined"
                    ) {
                    ...
                    if (keys.length > 0) {
                        for (var i = 0; i < keys.length; i++) {
                            if (typeof cell[i] == "string") {
                                var columnId = jexcel.getIdFromColumnName(
                                    cell[i],
                                    true
                                );
                                var x = columnId[0];
                            ...
                            if (x != null && y != null) {
                                records.push(
                                    obj.updateCell(x, y, value, force)
                                );
        ...
        obj.updateCell = function (x, y, value, force) {
            ...
            if (
                obj.records[y][x].classList.contains("readonly") == true &&
                !force
            ) {
                // Do nothing
                var record = {
                ...
                if (obj.options.columns[x].editor) {
                    ...
                    if (
                        ...
                        // Update data and cell
                        obj.options.data[y][x] = value;
                        obj.records[y][x].innerText = obj.getDropDownValue(
                            x,
                            value
                        );
                    } else if (obj.options.columns[x].type == "calendar") {
                        ...
                        obj.records[y][
                            x
                        ].innerText = jSuites.calendar.getDateString(
                            formatted ? formatted : value,
                            obj.options.columns[x].options.format
                        );
                    } else if (obj.options.columns[x].type == "color") {
                ...
                for (var i = x1; i <= x2; i++) {
                    ...
                    if (
                        ...
                        if (
                            value &&
                            !data[1] &&
                            obj.options.autoIncrement == true
                        ) {
                            if (
                                obj.options.columns[i].type == "text" ||
        ...
        obj.resetSelection = function (blur) {
            ...
            if (!obj.highlighted.length) {
                ...
                for (var i = 0; i < obj.highlighted.length; i++) {
                    ...
                    var px = parseInt(
                        obj.highlighted[i].getAttribute("data-x")
                    );
                    var py = parseInt(
                        obj.highlighted[i].getAttribute("data-y")
                    );

                    // Check for merged cells
                    if (obj.highlighted[i].getAttribute("data-merged")) {
                        var colspan = parseInt(
                            obj.highlighted[i].getAttribute("colspan")
                        );
                        var rowspan = parseInt(
                            obj.highlighted[i].getAttribute("rowspan")
                        );
        ...
        obj.updateSelectionFromCoords = function (x1, y1, x2, y2, origin) {
            ...
            if (x1 != null) {
                ...
                for (var i = px; i <= ux; i++) {
                    for (var j = py; j <= uy; j++) {
                        if (
                            ...
                            var x = parseInt(
                                obj.records[j][i].getAttribute("data-x")
                            );
                            var y = parseInt(
                                obj.records[j][i].getAttribute("data-y")
                            );
                            var colspan = parseInt(
                                obj.records[j][i].getAttribute("colspan")
                            );
                            var rowspan = parseInt(
                                obj.records[j][i].getAttribute("rowspan")
                            );
                ...
                for (var i = borderLeft; i <= borderRight; i++) {
                    if (obj.options.columns[i].type != "hidden") {
                        ...
                        if (
                            ...
                            obj.records[borderTop][i].classList.add(
                                "highlight-top"
                            );
                        }
                        // Bottom border
                        if (
                            ...
                            obj.records[borderBottom][i].classList.add(
                                "highlight-bottom"
                            );
                        }
                ...
                for (var j = borderTop; j <= borderBottom; j++) {
                    if (obj.rows[j] && obj.rows[j].style.display != "none") {
                        // Left border
                        obj.records[j][borderLeft].classList.add(
                            "highlight-left"
                        );
                        // Right border
                        obj.records[j][borderRight].classList.add(
                            "highlight-right"
                        );
                ...
                for (var j = py; j <= uy; j++) {
                    for (var i = px; i <= ux; i++) {
                        if (
                            ...
                            obj.records[uy][i].classList.add(
                                "selection-bottom"
                            );
        ...
        obj.updateCornerPosition = function () {
            ...
            if (!obj.highlighted.length) {
                ...
                if (obj.options.freezeColumns) {
                    ...
                    if (
                        lastX > obj.options.freezeColumns - 1 &&
                        x2 - x1 + w2 < width
                    ) {
                        obj.corner.style.display = "none";
                    } else {
        ...
        obj.updateScroll = function (direction) {
            ...
            // Top position check
            if (
                y > obj.content.scrollTop + 30 &&
                y < obj.content.scrollTop + h1
            ) {
                // In the viewport
            } else {
                // Out of viewport
            ...
            if (width) {
                if (Array.isArray(column)) {
                    ...
                    for (var i = 0; i < column.length; i++) {
                        if (!oldWidth[i]) {
                            oldWidth[i] = obj.colgroup[column[i]].getAttribute(
                                "width"
                            );
                        }
                        var w =
                            Array.isArray(width) && width[i] ? width[i] : width;
            ...
            if (k && v) {
                ...
                for (var i = 0; i < keys.length; i++) {
                    ...
                    for (var j = 0; j < prop.length; j++) {
                        obj.options.meta[keys[i]][prop[j]] =
                            o[keys[i]][prop[j]];
                    }
                }
            }
        ...
        obj.setStyle = function (o, k, v, force, ignoreHistoryAndEvents) {
            ...
            var applyStyle = function (cellId, key, value) {
                ...
                if (
                    obj.records[cell[1]] &&
                    obj.records[cell[1]][cell[0]] &&
                    (obj.records[cell[1]][cell[0]].classList.contains(
                        "readonly"
                    ) == false ||
                        force)
                ) {
        ...
        obj.setComments = function (cellId, comments, author) {
            ...
            var author = obj.records[cell[1]][cell[0]].getAttribute(
                "data-author"
            );
            ...
            if (comments) {
                ...
                obj.records[cell[1]][cell[0]].classList.remove(
                    "jexcel_comments"
                );
            }
        ...
        obj.orderBy = function (column, order) {
            if (column >= 0) {
                ...
                // Direction
                if (order == null) {
                    order = obj.headers[column].classList.contains("arrow-down")
                        ? 1
                        : 0;
                } else {
                    order = order ? 1 : 0;
                ...
                if (
                    ...
                    for (var j = 0; j < obj.options.data.length; j++) {
                        temp[j] = [
                            j,
                            obj.records[j][column].innerText.toLowerCase(),
                        ];
                    }
                }
                    ...
                    if (parseInt(rowNumber) > -1) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                obj.rows[row].parentNode.removeChild(
                                    obj.rows[row]
                                );
                            }
                        }
                        ...
                        // Remove data
                        var rowRecords = obj.records.splice(
                            rowNumber,
                            numOfRows
                        );
                        var rowData = obj.options.data.splice(
                            rowNumber,
                            numOfRows
                        );
            ...
            if (obj.options.allowInsertColumn == true) {
                ...
                for (var row = 0; row < obj.options.data.length; row++) {
                    ...
                    for (
                        ...
                        // Add cell to the row
                        if (obj.rows[row]) {
                            obj.rows[row].insertBefore(
                                td,
                                obj.rows[row].children[col + 1]
                            );
                        }
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            var j = 0;
                            j < obj.options.nestedHeaders.length;
                            j++
                        ) {
                            var colspan =
                                parseInt(
                            ...
                            var o = obj.thead.children[j].children[
                                obj.thead.children[j].children.length - 1
        ...
        obj.deleteColumn = function (columnNumber, numOfColumns) {
            ...
            if (obj.options.allowDeleteColumn == true) {
                if (obj.headers.length > 1) {
                    ...
                    if (
                        numOfColumns >
                        obj.options.data[0].length - columnNumber
                    ) {
                        numOfColumns =
                            obj.options.data[0].length - columnNumber;
                    }
                    ...
                    if (parseInt(columnNumber) > -1) {
                        ...
                        for (
                            ...
                            obj.colgroup[col].parentNode.removeChild(
                                obj.colgroup[col]
                            );
                            obj.headers[col].parentNode.removeChild(
                                obj.headers[col]
                            );
                        }

                        var historyHeaders = obj.headers.splice(
                            columnNumber,
                            numOfColumns
                        );
                        ...
                        if (obj.options.footers) {
                            for (
                                var row = 0;
                                row < obj.options.footers.length;
                                row++
                            ) {
                                historyFooters[row] = obj.options.footers[
                                    row
                                ].splice(columnNumber, numOfColumns);
                            }
                        }
                        ...
                        if (
                            ...
                            if (
                                ...
                                var colspan =
                                    parseInt(
                                        obj.options.nestedHeaders[0].colspan
                                    ) - numOfColumns;
                                obj.options.nestedHeaders[0].colspan = colspan;
                                obj.thead.children[0].children[
                                    obj.thead.children[0].children.length - 1
            ...
            for (var j = 0; j < obj.records.length; j++) {
                for (var i = 0; i < obj.records[0].length; i++) {
                    if (obj.records[j][i]) {
                        ...
                        // Update column
                        if (obj.records[j][i].getAttribute("data-merged")) {
                            var columnIdFrom = jexcel.getColumnNameFromId([
                                x,
                                y,
                            ]);
                            var columnIdTo = jexcel.getColumnNameFromId([i, j]);
                ...
                for (var i = 0; i < keys.length; i++) {
                    if (mergeCellUpdates[keys[i]]) {
                        ...
                        for (
                            ...
                            var x = parseInt(
                                obj.options.mergeCells[columnIdFrom][2][
                                    j
                                ].getAttribute("data-x")
                            );
                            var y = parseInt(
            ...
            if (obj.formula[cellId] && obj.formula[cellId].length > 0) {
                if (chainLoopProtection[cellId]) {
                    ...
                    for (var i = 0; i < obj.formula[cellId].length; i++) {
                        var cell = jexcel.getIdFromColumnName(
                        ...
                        if (value.substr(0, 1) == "=") {
                            records.push(
                                obj.updateCell(cell[0], cell[1], value, true)
                            );
                        } else {
        ...
        obj.updateFormulas = function (referencesToUpdate) {
            ...
            for (var j = 0; j < obj.options.data.length; j++) {
                for (var i = 0; i < obj.options.data[0].length; i++) {
                    ...
                    if (value.substr(0, 1) == "=") {
                        // Replace tokens
                        var newFormula = obj.updateFormula(
                            value,
                            referencesToUpdate
                        );
                        if (newFormula != value) {
                    ...
                    if (search(v, query, k)) {
                        ...
                        if (rows.length) {
                            for (var i = 0; i < rows.length; i++) {
                                var row = jexcel.getIdFromColumnName(
                                    rows[i],
                                    true
                                );
                                for (
                                    var j = 0;
                                    j < obj.options.mergeCells[rows[i]][1];
                                    j++
                                ) {
                                    addToResult(row[1] + j);
                                }
        ...
        obj.whichPage = function (cell) {
            ...
            return (
                Math.ceil(
                    (parseInt(cell) + 1) / parseInt(obj.options.pagination)
                ) - 1
            );
        };
        ...
        obj.updatePagination = function () {
            ...
            if (obj.options.pagination) {
                ...
                if (!results) {
                    ...
                    var quantyOfPages = Math.ceil(
                        results / obj.options.pagination
                    );

                    if (obj.pageNumber < 6) {
                        var startNumber = 1;
                        var finalNumber =
                            quantyOfPages < 10 ? quantyOfPages : 10;
            ...
            if (!returnData) {
                ...
                if (obj.highlighted) {
                    for (var i = 0; i < obj.highlighted.length; i++) {
                        ...
                        if (
                            obj.highlighted[i].classList.contains(
                                "highlight-left"
                            )
                        ) {
                ...
                while ((row = data[j])) {
                    ...
                    while (row[i] != null) {
                        ...
                        if (style && style[styleIndex]) {
                            var columnName = jexcel.getColumnNameFromId([
                                colIndex,
                                rowIndex,
                            ]);
        ...
        obj.historyProcessRow = function (type, historyRecord) {
            ...
            if (type == 1) {
                ...
                for (
                    var j = rowIndex;
                    j < historyRecord.numOfRows + rowIndex;
                    j++
                ) {
                    obj.tbody.insertBefore(
        ...
        obj.historyProcessColumn = function (type, historyRecord) {
            ...
            if (type == 1) {
                ...
                for (var j = 0; j < historyRecord.data.length; j++) {
                    for (
                        var i = columnIndex;
                        i < numOfColumns + columnIndex;
                        i++
                    ) {
                        obj.records[j][i].parentNode.removeChild(
                            obj.records[j][i]
                        );
                    }
                    ...
                    success: function (result) {
                        ...
                        if (
                            ...
                            for (var i = 0; i < headers.length; i++) {
                                ...
                                if (
                                    typeof obj.options.columns[i].title ===
                                    "undefined"
                                ) {
                ...
                if (y == null) {
                    ...
                    if (x) {
                        if (obj.options.allowComments == true) {
                            ...
                            var title =
                                obj.records[y][x].getAttribute("title") || "";
        ...
        obj.scrollControls = function (e) {
            ...
            if (
                ...
                if (
                    obj.edition &&
                    e.target.className.substr(0, 9) != "jdropdown"
                ) {
        ...
        obj.updateFreezePosition = function () {
            ...
            if (scrollLeft > 50) {
                ...
                for (var i = 0; i < obj.options.freezeColumns; i++) {
                    ...
                    for (var j = 0; j < obj.rows.length; j++) {
                        if (obj.records[j][i]) {
                            obj.records[j][i].classList.remove(
                                "jexcel_freezed"
                            );
        ...
        if (jexcel.current) {
            if (jexcel.current.edition) {
                if (e.which == 27) {
                    ...
                    if (jexcel.current.edition) {
                        // Exit without saving
                        jexcel.current.closeEditor(
                            jexcel.current.edition[0],
                            false
                        );
                    }
                    e.preventDefault();
                    ...
                    // Enter
                    if (
                        jexcel.current.options.columns[
                        ...
                        if (
                            (jexcel.current.options.wordWrap == true ||
                                ...
                                jexcel.current.options.data[
                                    jexcel.current.edition[3]
                                ][jexcel.current.edition[2]].length > 200) &&
                            e.altKey
                        ) {
                            // Add new line to the editor
                            var editorTextarea =
                                jexcel.current.edition[0].children[0];
                            var editorValue =
                                jexcel.current.edition[0].children[0].value;
                ...
                if (e.which == 37) {
                    ...
                    if (e.shiftKey) {
                        ...
                        if (jexcel.current.options.allowInsertRow == true) {
                            if (
                                jexcel.current.options.allowManualInsertRow ==
                                true
                            ) {
                                if (
                                    jexcel.current.selectedCell[1] ==
                ...
                if (jexcelTable[1] == 1) {
                    ...
                    if (columnId) {
                        ...
                        if (
                            ...
                            for (
                                var j = 0;
                                j < jexcel.current.records.length;
                                j++
                            ) {
                        ...
                        if (
                            ...
                            if (e.target.getAttribute("data-column")) {
                                ...
                                var c1 = 0;
                                var c2 =
                                    jexcel.current.options.columns.length - 1;
                            }
                            jexcel.current.updateSelectionFromCoords(
                                c1,
                                0,
        ...
        if (jexcel.current) {
            ...
            if (jexcel.current.resizing) {
                ...
                if (jexcel.current.resizing.column) {
                    ...
                    // Remove border
                    jexcel.current.resizing.element.classList.remove(
                        "resizing"
                    );
                }
                ...
                if (jexcel.current.dragging) {
                    if (jexcel.current.dragging.column) {
                        ...
                        for (
                            var i = 0;
                            i < jexcel.current.headers.length;
                            i++
                        ) {
                            jexcel.current.headers[i].classList.remove(
                                "dragging-left"
                            );
                            jexcel.current.headers[i].classList.remove(
                                "dragging-right"
                        ...
                        jexcel.current.dragging.element.classList.remove(
                            "dragging"
                        );
                    }
        ...
        if (jexcel.current) {
            if (jexcel.isMouseAction == true) {
                ...
                if (jexcel.current.resizing) {
                    if (jexcel.current.resizing.column) {
                        var width =
                            e.pageX - jexcel.current.resizing.mousePosition;

                        if (jexcel.current.resizing.width + width > 0) {
                            var tempWidth =
                                jexcel.current.resizing.width + width;
                            jexcel.current.colgroup[
                                jexcel.current.resizing.column
                        ...
                        var height =
                            e.pageY - jexcel.current.resizing.mousePosition;

                        if (jexcel.current.resizing.height + height > 0) {
                            var tempHeight =
                                jexcel.current.resizing.height + height;
                            jexcel.current.rows[
                                jexcel.current.resizing.row
                            ].setAttribute("height", tempHeight);
                    ...
                    if (jexcel.current.dragging.column) {
                        ...
                        if (columnId) {
                            if (jexcel.current.isColMerged(columnId).length) {
                                ...
                                if (
                                    jexcel.current.dragging.column == columnId
                                ) {
                                    jexcel.current.dragging.destination = parseInt(
                                        columnId
                                    );
                                } else {
                    ...
                    if (jexcelTable[1] == 2) {
                        if (e.target.classList.contains("jexcel_row")) {
                            ...
                            if (!jexcel.current.edition) {
                                if (columnId && rowId) {
                                    if (jexcel.current.selectedCorner) {
                                        jexcel.current.updateCopySelection(
                                            columnId,
                                            rowId
                                        );
                                    } else {
        ...
        if (jexcel.current) {
            ...
            if (e.target.classList.contains("jexcel_corner")) {
                ...
                if (jexcel.current.highlighted.length > 0) {
                    // Copy from this
                    var x1 = jexcel.current.highlighted[0].getAttribute(
                        "data-x"
                    );
                    var y1 =
                        parseInt(
                ...
                if (
                    jexcelTable[1] == 2 &&
                    jexcel.current.options.editable == true
                ) {
                    if (!jexcel.current.edition) {
                        var getCellCoords = function (element) {
                            if (element.parentNode) {
                    ...
                    var callPaste = function (data) {
                        ...
                        for (var row = minRow; row <= maxRow; row++) {
                            for (var col = minCol; col <= maxCol; col++) {
                                if (
                                    jexcel.current.options.columns[col].type !=
                                    "hidden"
                                ) {
            ...
            workbook.SheetNames.forEach(function (sheetName) {
                ...
                for (var i = 0; i < temp.length; i++) {
                    if (temp[i].substr(0, 1) != "!") {
                        ...
                        spreadsheet.data[info[1]][info[0]] = cell.f
                            ? "=" + cell.f
                            : cell.w;
                        if (max_x < info[0]) {
                            max_x = info[0];
    ...
    jexcel.getColumnNameFromId = function (cellId) {
        ...
        return (
            jexcel.getColumnName(parseInt(cellId[0])) +
            (parseInt(cellId[1]) + 1)
        );
    };
        ...
        if (el.tagName != "TABLE") {
            ...
            var parseHeader = function (header) {
                ...
                if (header.getAttribute("data-celltype")) {
                    options.columns[i].type = header.getAttribute(
                        "data-celltype"
                    );
                } else {
                ...
                for (var j = 0; j < headers.length - 1; j++) {
                    ...
                    for (var i = 0; i < headers[j].children.length; i++) {
                        var row = {
                            ...
                            colspan:
                                headers[j].children[i].getAttribute(
                                    "colspan"
                                ) || 1,
                        };
                        cells.push(row);
            ...
            var content = el.querySelectorAll(
            ...
            for (var j = 0; j < content.length; j++) {
                ...
                if (
                    ...
                    for (var i = 0; i < content[j].children.length; i++) {
                        ...
                        var value = content[j].children[i].getAttribute(
                            "data-formula"
                        );
                        if (value) {
                            if (value.substr(0, 1) != "=") {
                        ...
                        var mergedColspan =
                            parseInt(
                                content[j].children[i].getAttribute("colspan")
                            ) || 0;
                        var mergedRowspan =
                            parseInt(
                                content[j].children[i].getAttribute("rowspan")
                            ) || 0;
                        ...
                        // Bold
                        if (
                            content[j].children[i].classList.contains(
                                "styleBold"
                            )
                        ) {
                            if (style[cellName]) {
            ...
            $.fn.jspreadsheet = $.fn.jexcel = function (mixed) {
                ...
                if (!spreadsheetContainer.jexcel) {
                    ...
                    if (Array.isArray(spreadsheetContainer.jexcel)) {
                        return spreadsheetContainer.jexcel[mixed][
                            arguments[1]
